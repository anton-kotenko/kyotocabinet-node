...
kyotonode.node: main.cc argv_helpers.hh exportcachedb.hh exportdirdb.hh exportforestdb.hh exportgrassdb.hh exporthashdb.cc exporthashdb.hh exportpolydb.hh exportprotohashdb.hh exportprototreedb.hh exportstashdb.hh exporttextdb.hh exporttov8.cc exporttov8.hh exporttreedb.hh exportvisitor.cc exportvisitor.hh main.cc Makefile standart_progress_checker.hh exportcursor.cc exportcursor.hh
